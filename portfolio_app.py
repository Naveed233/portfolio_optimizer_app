    ...
    try:
        ...
        if isinstance(raw_data.columns, pd.MultiIndex):
            if 'Adj Close' not in raw_data.columns.levels[0]:
                raise ValueError("No valid 'Adj Close' data was returned. Check your tickers and date range.")
        ...
        if adj_close.empty:
            raise ValueError("All returned price data were NaN or missing. Double-check your tickers/date range.")
